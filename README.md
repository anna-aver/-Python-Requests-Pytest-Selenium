...
| ** |                                             |                  |
+====+=============================================+==================+
| 1  | > Позитивная проверка:                      | Успешная         |
|    |                                             | авторизация,     |
|    | -   Корректная почта                        | сравнение id     |
|    |                                             | тренера          |
|    | -   Корректный пароль                       |                  |
+----+---------------------------------------------+------------------+
| 2  | > Негативные проверки:                      |                  |
+----+---------------------------------------------+------------------+
| 2  | -   Некорректная почта                      | Введите          |
| .1 |                                             | корректную почту |
|    | -   Корректный пароль                       |                  |
+----+---------------------------------------------+------------------+
| 2  | -   Корректная почта                        | Неверные логин   |
| .2 |                                             | или пароль       |
|    | -   Некорректный пароль                     |                  |
+----+---------------------------------------------+------------------+
| 2  | -   Некорректная почта                      | Введите          |
...
|    | -   Некорректный пароль                     |                  |
+----+---------------------------------------------+------------------+
| 2  | -   Пустая почта                            | Введите почту    |
| .4 |                                             |                  |
|    | -   Корректный пароль                       |                  |
+----+---------------------------------------------+------------------+
| 2  | -   Корректная почта                        | Введите пароль   |
| .5 |                                             |                  |
|    | -   Пустой пароль                           |                  |
+----+---------------------------------------------+------------------+
